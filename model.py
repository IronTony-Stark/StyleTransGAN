...
class MappingNetwork(nn.Module):
    """
    Mapping Network is an MLP with 8 linear layers.
...
class Conv2dWeightModulate(nn.Module):
    """
    Convolution with Weight Modulation and Demodulation scales
    the convolution weights by the style vector and demodulates by normalizing it.
    """
